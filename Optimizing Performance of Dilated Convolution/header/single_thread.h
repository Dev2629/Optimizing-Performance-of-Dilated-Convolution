...
// void singleThread_optimization_1( int input_row, 
//                 int input_col,
//                 int *input, 
//                 int kernel_row, 
//                 int kernel_col, 
...
//                 for(int kernel_i = 0; kernel_i< kernel_row; kernel_i++)
//                 {
//                     int input_row_offset=input_i*input_col;
//                     for(int kernel_j = 0; kernel_j< kernel_col; kernel_j++)
//                     {
//                         int input_j = (output_j + 2*kernel_j) % input_col;
//                         output_sum+= input[input_row_offset+input_j] * kernel[temp2 +kernel_j];
//                     }
//                     input_i = (input_i + 2) % input_row;
//                     temp2+=kernel_col;
//                 }
//                 output[output_row_offset+output_j]=output_sum;
//             }
//             output_row_offset+=output_col;
//         }
// }